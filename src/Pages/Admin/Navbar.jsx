  ...
  return (
    <div className="flex items-center justify-between bg-white shadow-lg p-6 rounded-b-2xl">
      ...
      <div className="flex items-center gap-6">
        <FaBell className="text-gray-600 text-2xl cursor-pointer hover:text-indigo-600 transition-colors duration-200" />
        <div className="relative">
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-50">
              ...
              {/* 4. Attach the onClick handler to the logout link */}
              <a
                href="/"
                onClick={handleLogout}
                className="flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50 transition-colors duration-200 cursor-pointer"
              >
